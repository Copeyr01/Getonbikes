...
**Mobile (≤860px):** the floating card detaches from the photo and becomes a plain full-width block underneath it, rather than an overlay — mirroring the supplied reference's own mobile layout. The heading/subtitle stay overlaid on the (shorter) image, bottom-anchored.
